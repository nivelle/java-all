package com.nivelle.programming.datastructures.linkedList.oneWayLinked;

import com.nivelle.programming.datastructures.linkedList.ILinkedList;

/**
 * 单项链表的实现,不含独立头结点,不含尾部指针
 */
public class OneWayLinkedList<T> implements ILinkedList<T> {

    protected Node<T> head; //带数据头结点

    public OneWayLinkedList(Node<T> head) {
        this.head = head;
    }
     ...
     * @param array
     */
    public OneWayLinkedList(T[] array) {
        this.head = null;
     ...
     * @param list
     */
    public OneWayLinkedList(OneWayLinkedList<T> list) {
        this.head = null;
     ...
     * @param list
     */
    public void concat(OneWayLinkedList<T> list) {
    ...
    public static void main(String[] args) {
        ...
        OneWayLinkedList<String> list = new OneWayLinkedList<>(letters);

        System.out.println(list.head.nextNode().data);


        OneWayLinkedList<String> list1 = new OneWayLinkedList(list);
