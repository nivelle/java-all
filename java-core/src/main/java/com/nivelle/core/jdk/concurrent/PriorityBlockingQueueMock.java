...
import com.nivelle.core.pojo.PriorityBlockingQueueComparator;
 ...
 * @date 2020/04/16
 */
public class PriorityBlockingQueueMock {
    ...
    public static void main(String[] args) {
         ...
         *
         *
         *  ## 默认比较器(自下而上的堆化,小顶堆) 插入元素的时间复杂度为: O(log n)
         ...
         *         // 先释放锁，因为是从offer()方法的锁内部过来的;先释放锁,使用 allocationSpinLock 变量控制扩容的过程
         *         // 防止阻塞的线程过多
        ...
        /**
         * （1）PriorityBlockingQueue整个入队出队的过程与 PriorityQueue 基本是保持一致的；
         *
