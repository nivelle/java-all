...
public class ObjectMock {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < methods.length; i++) {
            System.out.println("object 默认的方法:" + methods[i].getName());
         ...
         */
        /**
         * hashCode主要用在哈希表中用来定位,所以一般需要重写hashCode方法和equals方法
         ...
         */
        new Thread(() -> {
            int objectHashCode = object.hashCode();//933699219
            System.out.println(Thread.currentThread().getName() + ":object默认的hashCode方法=》" + objectHashCode);
        }).start();
