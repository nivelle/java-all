...
public class ArrayUnTransListMock {
    ...
    public static void testArray() {
        ...
        System.out.println("son数组类型：" + sonArray.getClass());

        Parent[] parentArray = sonArray;
        System.out.println("parent数组类型:" + parentArray.getClass());
        ...
        System.out.println((Son)sonArray2[0]);
    ...
    public static void testArrayToList() {
        ...
        System.out.println("Arrays内部的list类型:" + list.getClass());
        /**
        ...
        System.out.println("list.toArray 方法返回底层数组的实际类型:" + objArray.getClass());
    ...
    public static void testListToArray() {
        ...
        System.out.println("list to Array before:" + listToArray.getClass());
